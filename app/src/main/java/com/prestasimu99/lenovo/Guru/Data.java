...
public class Data{
	...
	@SerializedName("user_cekbox")
	private String userCekbox;
    ...
    public void setUserCekbox(String userCekbox){
        this.userCekbox = userCekbox;
    }

    public String getUserCekbox(){
        return userCekbox;
    }
